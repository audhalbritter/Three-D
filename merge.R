...
fluxes <- dir_ls(location, regexp = "*CO2*") %>% 
  ...
  write_csv("/home/jga051/Documents/01_PhD/05_data/01_summer2020/Three-D_cfluxes_2020.csv")
...
PAR <-
  ...
  write_csv("/home/jga051/Documents/01_PhD/05_data/01_summer2020/Three-D_PAR_2020.csv")
...
temp_air <-dir_ls(location, regexp = "*temp*") %>% 
  ...
  # 
  write_csv("/home/jga051/Documents/01_PhD/05_data/01_summer2020/Three-D_tempair_2020.csv")
