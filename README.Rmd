...
A filter prevents water droplets and small particules from entering the INGRA and an air pump ensures a flow or 1L/mn.
...
Airtightness is ensured by laying a heavy chain on the "skirt" of the chamber.
The CO2 concentration was measured every seconds and logged in a datalogger (Squirrel 2010).
The chamber was put on the plot during two minutes for each measurements and then aired during one minute.
Since the logger was logging continuesly, it was necessary to keep track at what time each measurements started.
