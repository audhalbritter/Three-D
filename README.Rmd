...
tibble(Variable = c("Elevation", "Coordinates, slope and aspect", 
                    ...
                    "Decomposition",
                    "Air, ground and soil temperature, and soil moisture", "Gridded climate"),
       Period = c("2019", "2019", "2019-2021", "2019-2021", "2019-2021", "2019-2021", "2020-2021", "2021", "2021", "2021", "2020-2021", "2020-2021", "2021", rep("2019", 5), "2019-2020", "2021", "2021", "2019-2021", "2009-2020"),
       Level = c("site", "plot", "plot", "subplot", rep("plot", 10), "site", "plot", "site", "block", "site", "site", "plot", "plot", "site"),
       File = c("THREE-D_metaSite.csv", "THREE-D_metaSite.csv", 
                ...
                "THREE_D_Gridded_DailyClimate_2009-2019.csv")
       ) %>% 
...
PRS probes were installed for 35 days at peak growing season (July - August) in plots with 0, 10 and 150 kg N per ha and y, ambient and warmed temperature and intermediate, intensive and not grazed plots.
The probes were retrieved, brought back to the lab, washed with deionized water and shipped to the lab for analysis.
