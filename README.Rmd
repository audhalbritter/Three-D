...
```{r proposal_figure, fig.cap= "Figure 1. Pathways of warmer climate, nitrogen deposition and grazing via productiviy and biomass on biodiverstiy and ecosystem function."}
...
### Warming treatment
The warming treatment was conducted at the end of the growing season in 2019, by transplanting entire plant communities to the lower elevation (c. +2-3°C).
...
The following datasets were collected and are available : https://osf.io/pk4bg/
...
```{r subplots, fig.cap= "Figure 3: Plot and sub-plot design. Orange plots indicate the subplot for the vegetation height measurements."}
...
### Reflectance
Reflectance (greeness) was measured several times during the season in each plot from 2020-2021 (2022).
...
#### Grazing treatment
biomass was clipped and harvested as a grazing treatment in the plots that received intermediate or intensive grazing.
...
#### Biomass harvest
Biomass will was harvested at the end of the growing season in 2021 from all plots.
...
#### Climate data
Temperature was measured continuously (every 15 min) at three heights (15 cm, at ground level, and 5 cm below ground) and soil moisture was measured continuously 5 cm below ground using Tomst TM4 loggers (Wild et al., 2019).
